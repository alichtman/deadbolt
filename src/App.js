...
export default class App extends Component {
	...
	onEncrypt = (password) => {
		...
		const encryptedFilePath = window.electronAPI.encryptFileRequest(
			filePath,
			password,
		);
	...
	onDecrypt = (password) => {
		...
		const decryptedFilePath = window.electronAPI.decryptFileRequest(
			filePath,
			password,
		);

		// app.on("decryptFileResponse", (event, arg) => {
